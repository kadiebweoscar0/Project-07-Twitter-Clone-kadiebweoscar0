...
function TweetAction(props) {
  ...
  return (
    <div className="tweet-actions">
      ...
      onMousseEnter={handleIconHover(0)} 
      onMouseLeave={handleIconHover(0)} 
      onClick={()=>handleLikeClick("comment")} 
      nameIcone={commentIcon}/>

      <Retweet 
      value={actionCount.retweet} 
      onMousseEnter={handleIconHover(1)} 
...
export  function Comment({value, onMousseEnter, onMouseLeave, onClick, nameIcone}) {
  return (
    <>
...
export  function Retweet({value, onMousseEnter, onMouseLeave, onClick, nameIcone}) {
  return (
    <>
          <span className="tweet-editor-actions hover-of-action" 
          onClick={onClick}
          // {()=>handleLikeClick("retweet")} 
          // onMouseEnter= {onMousseEnter}
          // {handleIconHover(1)} 
          // onMouseLeave= {onMouseLeave} 
          // {handleIconHover(1)}
